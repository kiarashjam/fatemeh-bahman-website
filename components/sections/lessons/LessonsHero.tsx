...
export function LessonsHero() {
  ...
  const content = {
    en: {
      title: 'Comprehensive Persian Lessons',
      subtitle: 'Master reading, writing, conversation, and cultural understanding',
    },
    fa: {
      title: 'درس‌های جامع فارسی',
      subtitle: 'تسلط بر خواندن، نوشتن، گفتگو و درک فرهنگی',
    },
  }
